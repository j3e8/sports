...
const searchDomain = 'https://www.startpage.com';
const url = 'https://www.startpage.com/search?q=%22TSHQ+License+Agreement%22+email&qs=n&form=QBLH&sp=-1&pq=%22tshq+license+agreement%22+email&sc=1-30&sk=&cvid=D8E807C40FEE40DE9AC2ED8FF14804F7';
...
function parseSearchResults (html) {
  ...
  const filtered = matches.filter(m => !m.includes('startpage') && !m.includes('gc.com') && m[0] !== '/' && !m.includes('bluesombrero'));
